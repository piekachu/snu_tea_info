...
(function () {
    ...
    var DICT = {
        ...
        /* 불참비 및 소모임 인원 관련규정 — the per-activity amounts
           themselves now live in refund.fee.* (shared table on both this
           page and notice/refund-policy.html); ot.rules.* is just the
           section title plus the two rules that don't fit a table row. */
        ...
        "refund.exemptShort.body":  { ko: "서울대학교 학칙(학업성적 처리 규정 제4조)에 따른 출석인정 사유에 해당하는 경우 불참비가 면제됩니다. 해당 사유와 증빙서류는 회계부장에게 개인톡으로 문의해주세요.",
                                      en: "If your absence qualifies as an excused absence under Seoul National University's academic regulations (Article 4 of the Academic Performance Handling Regulation), you're exempt from the no-show fee. Please message the treasurer directly to check whether your case qualifies and what documentation you'll need." },
